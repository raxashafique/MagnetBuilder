...
namespace MagnetBuilder.Core
{
	...
	public class EventListener<T>
	{
		...
		/// <param name="listener">
		///     Name of the method that you want to subscribe with the event. The method should have parameter
		///     type
		/// </param>
		...
		/// T is generic type that means you can create any type of event e.g int, float, or any custom class.
		/// <param name="listener">
		///     Name of the method that you want to unsubscribe with the event. The method should have parameter
		///     type.
		/// </param>
	...
	public class EventCallBack<T>
	{
		...
		public T Invoke()
		{
			return OnActionListener != null ? OnActionListener.Invoke() : default;
		}
	}
	...
	public class EventCallBack<T, TResult>
	{
		...
		{
			return OnActionListener != null ? OnActionListener.Invoke(value) : default;
		}
	}
}